...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("gfx/debug/console_debug.png",loader);
	...
	ApplicationMain.loaders.set("gfx/debug/console_logo.png",loader2);
	ApplicationMain.total++;
	var loader3 = new flash.display.Loader();
	ApplicationMain.loaders.set("gfx/debug/console_output.png",loader3);
	ApplicationMain.total++;
	var loader4 = new flash.display.Loader();
	ApplicationMain.loaders.set("gfx/debug/console_pause.png",loader4);
	ApplicationMain.total++;
	var loader5 = new flash.display.Loader();
	ApplicationMain.loaders.set("gfx/debug/console_play.png",loader5);
	ApplicationMain.total++;
	var loader6 = new flash.display.Loader();
	ApplicationMain.loaders.set("gfx/debug/console_step.png",loader6);
	ApplicationMain.total++;
	var loader7 = new flash.display.Loader();
	ApplicationMain.loaders.set("gfx/debug/console_visible.png",loader7);
	ApplicationMain.total++;
...
com.haxepunk.Engine.prototype = $extend(flash.display.Sprite.prototype,{
	...
	,setStageProperties: function() {
		...
		com.haxepunk.HXP.stage.addEventListener(flash.events.Event.ACTIVATE,function(e1) {
			com.haxepunk.HXP.focused = true;
			_g.focusGained();
			com.haxepunk.HXP._scene.focusGained();
		});
		com.haxepunk.HXP.stage.addEventListener(flash.events.Event.DEACTIVATE,function(e2) {
	...
	,checkScene: function() {
		...
		if(com.haxepunk.HXP._scene != null) {
			...
			if(this.contains(com.haxepunk.HXP._scene.sprite)) this.removeChild(com.haxepunk.HXP._scene.sprite);
			com.haxepunk.HXP._scene = com.haxepunk.HXP._goto;
			com.haxepunk.HXP._goto = null;
			this.addChild(com.haxepunk.HXP._scene.sprite);
...
var Main = function(width,height,frameRate,fixed) {
	...
	if(height == null) height = 0;
	if(width == null) width = 0;
	com.haxepunk.Engine.call(this,640,480,frameRate,fixed);
};
$hxClasses["Main"] = Main;
Main.__name__ = ["Main"];
Main.main = function() {
...
Main.prototype = $extend(com.haxepunk.Engine.prototype,{
	init: function() {
		this.setupSharedObject();
		Main.sceneMenu = new scenes.MainMenu();
		Main.sceneGame = new scenes.Game();
		com.haxepunk.HXP.set_scene(Main.sceneMenu);
	}
	,setupSharedObject: function() {
		try {
			Main.so = flash.net.SharedObject.getLocal("highscore");
		} catch( error ) {
			haxe.Log.trace("SharedObject error: " + Std.string(error),{ fileName : "Main.hx", lineNumber : 45, className : "Main", methodName : "setupSharedObject"});
		}
		Main.so.data.sessionbest = 0;
		Main.so.flush();
		if(Main.so.data.score == null) {
			Main.so.data.score = 0;
			Main.so.flush();
		}
	}
	,focusLost: function() {
...
var DefaultAssetLibrary = function() {
	...
	this.addExternal("gfx/debug/console_debug.png","image","gfx/debug/console_debug.png");
	this.addExternal("gfx/debug/console_hidden.png","image","gfx/debug/console_hidden.png");
	this.addExternal("gfx/debug/console_logo.png","image","gfx/debug/console_logo.png");
	this.addExternal("gfx/debug/console_output.png","image","gfx/debug/console_output.png");
	this.addExternal("gfx/debug/console_pause.png","image","gfx/debug/console_pause.png");
	this.addExternal("gfx/debug/console_play.png","image","gfx/debug/console_play.png");
	this.addExternal("gfx/debug/console_step.png","image","gfx/debug/console_step.png");
	...
	this.addExternal("audio/death.wav","sound","audio/death.wav");
	this.addExternal("audio/jump.wav","sound","audio/jump.wav");
...
com.haxepunk.Scene.prototype = $extend(com.haxepunk.Tweener.prototype,{
	...
	,bringToFront: function(e) {
		...
		if(e._renderNext != null) e._renderNext._renderPrev = e._renderPrev; else this._renderLast.set(e._layer,e._renderPrev);
		e._renderNext = this._renderFirst.get(e._layer);
		e._renderNext._renderPrev = e;
		this._renderFirst.set(e._layer,e);
		e._renderPrev = null;
		return true;
	}
	,sendToBack: function(e) {
		...
		if(e._renderPrev != null) e._renderPrev._renderNext = e._renderNext; else this._renderFirst.set(e._layer,e._renderNext);
		e._renderPrev = this._renderLast.get(e._layer);
		e._renderPrev._renderNext = e;
		this._renderLast.set(e._layer,e);
		e._renderNext = null;
		return true;
	}
	,bringForward: function(e) {
		...
		e._renderNext._renderPrev = e;
		if(e._renderPrev != null) e._renderPrev._renderNext = e; else this._renderFirst.set(e._layer,e);
		return true;
	}
	,sendBackward: function(e) {
		...
		e._renderPrev._renderNext = e;
		if(e._renderNext != null) e._renderNext._renderPrev = e; else this._renderLast.set(e._layer,e);
		return true;
	}
	...
	,layerCount: function(layer) {
		if(this._layerCount.exists(layer)) return this._layerCount.get(layer); else return 0;
	}
	,get_first: function() {
	...
	,layerFirst: function(layer) {
		if(this._updateFirst == null) return null;
		return this._renderFirst.get(layer);
	}
	,layerLast: function(layer) {
		if(this._updateFirst == null) return null;
		return this._renderLast.get(layer);
	}
	,get_farthest: function() {
		if(this._updateFirst == null) return null;
		return this._renderLast.get(this._layerList[this._layerList.length - 1]);
	}
	,get_nearest: function() {
		if(this._updateFirst == null) return null;
		return this._renderFirst.get(this._layerList[0]);
	}
	...
	,getLayer: function(layer,into) {
		var e = this._renderLast.get(layer);
		var n = into.length;
		while(e != null) {
			into[n++] = e;
			e = e._updatePrev;
	...
	,addRender: function(e) {
		var next = this._renderFirst.get(e._layer);
		if(next != null) {
			e._renderNext = next;
			next._renderPrev = e;
			var value = this._layerCount.get(e._layer) + 1;
			this._layerCount.set(e._layer,value);
		} else {
			this._renderLast.set(e._layer,e);
			this._layerList[this._layerList.length] = e._layer;
			this._layerSort = true;
			e._renderNext = null;
			this._layerCount.set(e._layer,1);
		}
		this._renderFirst.set(e._layer,e);
		e._renderPrev = null;
	}
	,removeRender: function(e) {
		...
		if(e._renderPrev != null) e._renderPrev._renderNext = e._renderNext; else {
			this._renderFirst.set(e._layer,e._renderNext);
		...
		var count = this._layerCount.get(e._layer) - 1;
		if(count > 0) this._layerCount.set(e._layer,count); else {
...
com.haxepunk.RenderMode = $hxClasses["com.haxepunk.RenderMode"] = { __ename__ : ["com","haxepunk","RenderMode"], __constructs__ : ["BUFFER","HARDWARE"] };
...
com.haxepunk.Screen.prototype = {
	...
	,update: function() {
		...
		var _g1 = this._matrix;
		_g1.set_ty(_g1.ty + (this.originY * this.fullScaleY + this.y));
...
com.haxepunk.Tween.prototype = $extend(flash.events.EventDispatcher.prototype,{
	...
	,finish: function() {
		...
		this._finish = false;
		this.dispatchEvent(new com.haxepunk.tweens.TweenEvent(com.haxepunk.tweens.TweenEvent.FINISH));
		if(this._callback != null) this.removeEventListener(com.haxepunk.tweens.TweenEvent.FINISH,this._callback);
	}
	,cancel: function() {
		this.active = false;
...
com.haxepunk.debug = {};
com.haxepunk.debug.TraceCapture = $hxClasses["com.haxepunk.debug.TraceCapture"] = { __ename__ : ["com","haxepunk","debug","TraceCapture"], __constructs__ : ["No","Yes"] };
...
com.haxepunk.debug.Console.prototype = {
	...
	,enable: function(trace_capture,toggleKey) {
		...
		this.LOG.push("-- HaxePunk v" + "2.5.2" + " --");
		if(this._enabled && this._sprite.get_visible()) this.updateLog();
	}
	,onResize: function(e) {
	...
	,updateDebugRead: function() {
		var str;
		var big = this.get_width() >= 420;
		var s = "Mouse: " + Std.string(Std["int"](com.haxepunk.HXP.screen.get_mouseX() + com.haxepunk.HXP._scene.camera.x)) + ", " + Std.string(Std["int"](com.haxepunk.HXP.screen.get_mouseY() + com.haxepunk.HXP._scene.camera.y)) + "\nCamera: " + Std.string(com.haxepunk.HXP.camera.x) + ", " + Std.string(com.haxepunk.HXP.camera.y);
		if(this.SELECT_LIST.length != 0) {
...
com.haxepunk.debug.LayerList.prototype = $extend(flash.display.Sprite.prototype,{
	...
	,set: function(list) {
		...
		var i = 0;
		var scene = com.haxepunk.HXP._scene;
		var _g = 0;
...
com.haxepunk.graphics.Image = function(source,clipRect,name) {
	...
	if(this._source == null && this._region == null) {
		this._class = name;
		if(js.Boot.__instanceof(source,com.haxepunk.graphics.atlas.TextureAtlas)) this.setAtlasRegion((js.Boot.__cast(source , com.haxepunk.graphics.atlas.TextureAtlas)).getRegion(name)); else if(js.Boot.__instanceof(source,com.haxepunk.graphics.atlas.AtlasRegion)) this.setAtlasRegion(source); else if(js.Boot.__instanceof(source,com.haxepunk.graphics.atlas.TileAtlas)) this.setAtlasRegion((js.Boot.__cast(source , com.haxepunk.graphics.atlas.TileAtlas)).getRegion(0)); else if(com.haxepunk.HXP.renderMode == com.haxepunk.RenderMode.HARDWARE) {
			if(typeof(source) == "string") this._class = source; else if(name == "") this._class = Type.getClassName(Type.getClass(source));
			this.setAtlasRegion(com.haxepunk.graphics.atlas.Atlas.loadImageAsRegion(source));
...
com.haxepunk.graphics.Image.prototype = $extend(com.haxepunk.Graphic.prototype,{
	...
	,render: function(target,point,camera) {
		...
		if(this._buffer != null) {
			if(this.angle == 0 && sx == 1 && sy == 1 && this.blend == null) target.copyPixels(this._buffer,this._bufferRect,this._point,null,null,true); else {
				...
				var _g1 = this._matrix;
				_g1.set_ty(_g1.ty + (this.originY + this._point.y));
	...
	,renderAtlas: function(layer,point,camera) {
		...
		if(this.angle == 0) {
			...
			var d = sy * fsy * cos;
			var c = sy * fsy * -sin;
			var tx = -this.originX * sx;
			var ty = -this.originY * sy;
...
com.haxepunk.graphics._Text.StyleType_Impl_.fromTextOptions = function(object) {
	...
	while(_g < _g1.length) {
		var key = _g1[_g];
		++_g;
		if(Object.prototype.hasOwnProperty.call(format,key)) Reflect.setField(format,key,Reflect.field(object,key)); else throw "\"" + key + "\" is not a TextFormat property";
	}
	return com.haxepunk.graphics._Text.StyleType_Impl_._new(format);
};
...
com.haxepunk.graphics.Text = function(text,x,y,width,height,options) {
	...
	if(!Object.prototype.hasOwnProperty.call(options,"align")) options.align = flash.text.TextFormatAlign.LEFT;
...
com.haxepunk.graphics.Text.prototype = $extend(com.haxepunk.graphics.Image.prototype,{
	...
	,updateTextBuffer: function() {
		...
		if(this._richText == null) this._field.setTextFormat(this._format); else this.matchStyles();
		...
		if(this._width > this._source.get_width() || this._height > this._source.get_height()) {
			this._source = com.haxepunk.HXP.createBitmap(Std["int"](Math.max(this._width,this._source.get_width())),Std["int"](Math.max(this._height,this._source.get_height())),true);
	...
	,set_align: function(value) {
		...
		this._format.align = this.align = value;
		this.updateTextBuffer();
		return value;
	}
...
com.haxepunk.graphics.atlas.AtlasData = function(bd) {
	...
	this._flagRGB = true;
	if(bd.___textureBuffer != null) this.width = bd.___textureBuffer.width; else this.width = 0;
	if(bd.___textureBuffer != null) this.height = bd.___textureBuffer.height; else this.height = 0;
	this._refCount = 0;
	this._layerIndex = -1;
...
com.haxepunk.graphics.atlas.AtlasData.destroyAll = function() {
	var _g = 0;
	var _g1 = com.haxepunk.graphics.atlas.AtlasData._atlases;
	while(_g < _g1.length) {
		var atlas = _g1[_g];
		++_g;
		atlas.destroy();
...
com.haxepunk.graphics.atlas.AtlasData.prototype = {
	...
	,createRegion: function(rect,center) {
		var r = rect.clone();
		var p;
		if(center != null) p = new flash.geom.Point(center.x,center.y); else p = null;
		var tileIndex = this._tilesheet.addTileRect(r,p);
		return new com.haxepunk.graphics.atlas.AtlasRegion(this,tileIndex,rect);
	}
	,flush: function() {
		if(this._dataIndex != 0) this._tilesheet.drawTiles(com.haxepunk.graphics.atlas.AtlasData._scene.sprite.get_graphics(),this._data,com.haxepunk.graphics.atlas.Atlas.smooth,this._renderFlags);
	}
...
com.haxepunk.graphics.atlas.AtlasRegion.prototype = {
	...
	,draw: function(x,y,layer,scaleX,scaleY,angle,red,green,blue,alpha) {
		...
		this._parent.prepareTile(this.tileIndex,x,y,layer,scaleX,scaleY,angle,red,green,blue,alpha);
	}
	,drawMatrix: function(tx,ty,a,b,c,d,layer,red,green,blue,alpha) {
		...
		if(this.rotated) {
			...
			this._parent.prepareTileMatrix(this.tileIndex,layer,matrix.tx,matrix.ty,matrix.a,matrix.b,matrix.c,matrix.d,red,green,blue,alpha);
		} else this._parent.prepareTileMatrix(this.tileIndex,layer,tx,ty,a,b,c,d,red,green,blue,alpha);
	}
	,destroy: function() {
...
com.haxepunk.masks.Hitbox.prototype = $extend(com.haxepunk.Mask.prototype,{
	collideMask: function(other) {
		if(other.parent != null) {
			...
			var py = this._y;
			if(this.parent != null) {
				px += this.parent.get_x();
				py += this.parent.get_y();
			}
			var ox = other.parent.originX + other.parent.get_x();
			var oy = other.parent.originY + other.parent.get_y();
			return px + this._width > ox && py + this._height > oy && px < ox + other.parent.width && py < oy + other.parent.height;
		}
		return false;
	}
	,collideHitbox: function(other) {
		...
		var oy = other._y;
		if(other.parent != null) {
			ox += other.parent.get_x();
			oy += other.parent.get_y();
		}
...
com.haxepunk.masks.Circle.prototype = $extend(com.haxepunk.masks.Hitbox.prototype,{
	collideMask: function(other) {
		var distanceX = Math.abs(this.parent.get_x() + this._x - other.parent.get_x() - other.parent.width * 0.5);
		var distanceY = Math.abs(this.parent.get_y() + this._y - other.parent.get_y() - other.parent.height * 0.5);
	...
	,collideGrid: function(other) {
		...
		var thisY = this._y;
		if(this.parent != null) {
			thisX += this.parent.get_x();
			thisY += this.parent.get_y();
		}
		var otherX = other.get_x();
		var otherY = other.get_y();
		if(other.parent != null) {
			otherX += other.parent.get_x();
			otherY += other.parent.get_y();
		}
...
com.haxepunk.masks.Grid.prototype = $extend(com.haxepunk.masks.Hitbox.prototype,{
	...
	,collideGrid: function(other) {
		...
		var x = 0;
		while(y < oy2) {
			var ar1 = Std["int"]((y - this.parent.get_y() - this._y) / this._tile.height);
			var br1 = Std["int"]((y - other.parent.get_y() - other._y) / other._tile.height);
			var ar2 = Std["int"]((y - this.parent.get_y() - this._y + (th - 1)) / this._tile.height);
			var br2 = Std["int"]((y - other.parent.get_y() - other._y + (th - 1)) / other._tile.height);
			x = ox1;
			while(x < ox2) {
				var ac1 = Std["int"]((x - this.parent.get_x() - this._x) / this._tile.width);
				var bc1 = Std["int"]((x - other.parent.get_x() - other._x) / other._tile.width);
				var ac2 = Std["int"]((x - this.parent.get_x() - this._x + (tw - 1)) / this._tile.width);
				var bc2 = Std["int"]((x - other.parent.get_x() - other._x + (tw - 1)) / other._tile.width);
	...
	,debugDraw: function(graphics,scaleX,scaleY) {
		...
		var px = this._x + this.parent.get_x() - com.haxepunk.HXP.camera.x;
		var py = this._y + this.parent.get_y() - com.haxepunk.HXP.camera.y;
...
com.haxepunk.masks.Pixelmask.prototype = $extend(com.haxepunk.masks.Hitbox.prototype,{
	...
	,set_data: function(value) {
		this._data = value;
		if(value.___textureBuffer != null) this._width = value.___textureBuffer.width; else this._width = 0;
		if(value.___textureBuffer != null) this._height = value.___textureBuffer.height; else this._height = 0;
		this.update();
		return this._data;
	}
...
com.haxepunk.masks.Polygon.prototype = $extend(com.haxepunk.masks.Hitbox.prototype,{
	...
	,collideHitbox: function(hitbox) {
		var offset;
		var offsetX = this.parent.get_x() + this._x - hitbox.parent.get_x();
		var offsetY = this.parent.get_y() + this._y - hitbox.parent.get_y();
		this.project(com.haxepunk.masks.Polygon.vertical,com.haxepunk.masks.Polygon.firstProj);
	...
	,collideGrid: function(grid) {
		...
		this._fakeEntity.set_x(this.parent.get_x());
		this._fakeEntity.set_y(this.parent.get_y());
		...
		while(_g1 < _g) {
			...
			while(_g3 < _g2) {
				var c = _g3++;
				this._fakeEntity.set_x(grid.parent.get_x() + grid._x + c * tileW);
				this._fakeEntity.set_y(grid.parent.get_y() + grid._y + r * tileH);
	...
	,debugDraw: function(graphics,scaleX,scaleY) {
		if(this.parent != null) {
			var offsetX = this.parent.get_x() + this._x - com.haxepunk.HXP.camera.x;
			var offsetY = this.parent.get_y() + this._y - com.haxepunk.HXP.camera.y;
...
com.haxepunk.masks.TileType = $hxClasses["com.haxepunk.masks.TileType"] = { __ename__ : ["com","haxepunk","masks","TileType"], __constructs__ : ["Empty","Solid","AboveSlope","BelowSlope","TopLeft","TopRight","BottomLeft","BottomRight"] };
...
com.haxepunk.utils.Input.get_mouseFlashX = function() {
	return Std["int"](com.haxepunk.HXP.stage.get_mouseX());
};
com.haxepunk.utils.Input.get_mouseFlashY = function() {
	return Std["int"](com.haxepunk.HXP.stage.get_mouseY());
};
...
com.haxepunk.utils.Input.check = function(input) {
	if(typeof(input) == "string") {
		...
		while(i-- > 0) {
			...
			if(com.haxepunk.utils.Input._key.get(v[i]) == true) return true;
		}
		return false;
	}
...
com.haxepunk.utils.Input.pressed = function(input) {
	if(typeof(input) == "string" && (function($this) {
		...
		var i = v.length;
		while(i-- > 0) if(v[i] < 0?com.haxepunk.utils.Input._pressNum != 0:HxOverrides.indexOf(com.haxepunk.utils.Input._press,v[i],0) >= 0) return true;
		return false;
	}
	if(input < 0) return com.haxepunk.utils.Input._pressNum != 0; else return com.haxepunk.HXP.indexOf(com.haxepunk.utils.Input._press,input) >= 0;
};
com.haxepunk.utils.Input.released = function(input) {
	if(typeof(input) == "string") {
		...
		v = com.haxepunk.utils.Input._control.get(key);
		var i = v.length;
		while(i-- > 0) if(v[i] < 0?com.haxepunk.utils.Input._releaseNum != 0:HxOverrides.indexOf(com.haxepunk.utils.Input._release,v[i],0) >= 0) return true;
		return false;
	}
	if(input < 0) return com.haxepunk.utils.Input._releaseNum != 0; else return com.haxepunk.HXP.indexOf(com.haxepunk.utils.Input._release,input) >= 0;
};
...
com.haxepunk.utils.JoyButtonState = $hxClasses["com.haxepunk.utils.JoyButtonState"] = { __ename__ : ["com","haxepunk","utils","JoyButtonState"], __constructs__ : ["BUTTON_ON","BUTTON_OFF","BUTTON_PRESSED","BUTTON_RELEASED"] };
...
var entities = {};
entities.Obstacle = function() {
	com.haxepunk.Entity.call(this);
	this.set_graphic(com.haxepunk.graphics.Image.createCircle(20,4504575,100));
	this.width = 30;
	this.height = 30;
	this.originX = -5;
	this.originY = -5;
	this.set_type("obstacle");
	this.set_layer(1);
};
$hxClasses["entities.Obstacle"] = entities.Obstacle;
entities.Obstacle.__name__ = ["entities","Obstacle"];
entities.Obstacle.__super__ = com.haxepunk.Entity;
entities.Obstacle.prototype = $extend(com.haxepunk.Entity.prototype,{
	init: function() {
		this.x = com.haxepunk.HXP.width;
		this.set_y((com.haxepunk.HXP.height - 40) * (function($this) {
			var $r;
			com.haxepunk.HXP._seed = com.haxepunk.HXP._seed * 16807.0 % 2147483647 | 0;
		...
		com.haxepunk.HXP._seed = com.haxepunk.HXP._seed * 16807.0 % 2147483647 | 0;
		this.vFactor = com.haxepunk.HXP._seed / 2147483647;
	}
	,update: function() {
		com.haxepunk.Entity.prototype.update.call(this);
		this.moveBy(-(7.0 + 7.0 * this.vFactor),0);
		if(!(this._scene == null?false:this.collideRect(this.followCamera?this.x + com.haxepunk.HXP.camera.x:this.x,this.followCamera?this.y + com.haxepunk.HXP.camera.y:this.y,this._scene.camera.x,this._scene.camera.y,com.haxepunk.HXP.width,com.haxepunk.HXP.height))) {
			entities.Obstacle.isOnCamera = false;
			this._scene.recycle(this);
		} else entities.Obstacle.isOnCamera = true;
	}
	,__class__: entities.Obstacle
});
entities.Player = function() {
	this.sfxDeath = new com.haxepunk.Sfx("audio/death.wav");
	this.sfxJump = new com.haxepunk.Sfx("audio/jump.wav");
	this._velocity = 0;
	this._takeoff = 8;
	this._gravity = 12;
	this._setY = com.haxepunk.HXP.halfHeight;
	this._setX = 100;
	com.haxepunk.Entity.call(this);
	this.set_graphic(com.haxepunk.graphics.Image.createCircle(20,14737616,100));
	this._graphic.x = -20;
	this._graphic.y = -20;
	this.width = 30;
	this.height = 30;
...
entities.Player.prototype = $extend(com.haxepunk.Entity.prototype,{
	added: function() {
		com.haxepunk.Entity.prototype.added.call(this);
		com.haxepunk.utils.Input.define("player_jump",[38,87,32]);
		this.init();
	}
	,update: function() {
		com.haxepunk.Entity.prototype.update.call(this);
		if(this.isReady && this.isAlive) {
			this.collidable = true;
			if(this._velocity < this._gravity) this._velocity += 0.5; else this._velocity = this._gravity;
			this.moveBy(0,this._velocity);
			if(!(this._scene == null?false:this.collideRect(this.followCamera?this.x + com.haxepunk.HXP.camera.x:this.x,this.followCamera?this.y + com.haxepunk.HXP.camera.y:this.y,this._scene.camera.x,this._scene.camera.y,com.haxepunk.HXP.width,com.haxepunk.HXP.height))) this.destroy();
			var e = this.collide("obstacle",this.followCamera?this.x + com.haxepunk.HXP.camera.x:this.x,this.followCamera?this.y + com.haxepunk.HXP.camera.y:this.y);
			if(e != null) {
				var o;
				o = js.Boot.__cast(e , entities.Obstacle);
				this.destroy();
			}
		} else this.collidable = false;
		if(com.haxepunk.utils.Input.pressed("player_jump") || com.haxepunk.utils.Input.mousePressed) {
			this._velocity = -this._takeoff;
			if(this.isAlive) this.sfxJump.play(0.8,0,false);
	...
	,destroy: function() {
		...
		this.isAlive = false;
		this.isReady = false;
		this.sfxDeath.play(0.6,0,false);
	}
	,init: function() {
		this.x = this._setX;
		this.y = this._setY;
...
flash.display.BitmapData.prototype = {
	...
	,threshold: function(sourceBitmapData,sourceRect,destPoint,operation,threshold,color,mask,copySource) {
		...
		if(mask == null) mask = -1;
		if(color == null) color = 0;
		haxe.Log.trace("BitmapData.threshold not implemented",{ fileName : "BitmapData.hx", lineNumber : 1171, className : "flash.display.BitmapData", methodName : "threshold"});
		return 0;
	}
...
flash.ui.Multitouch.get_supportsTouchEvents = function() {
	var supported = Reflect.hasField(window,"ontouchstart");
	return supported;
};
...
var gui = {};
gui.Control = function(x,y,alignment,width,height) {
	if(height == null) height = 0;
	if(width == null) width = 0;
	if(alignment == null) alignment = "top_left";
	if(y == null) y = 0;
	if(x == null) x = 0;
	com.haxepunk.Entity.call(this,x,y);
	this.width = width;
	this.height = height;
	this.set_graphic(com.haxepunk.graphics.Image.createRect(10,10,255,0));
	this.set_type("control");
	this.id = null;
	this.setRoot(alignment);
	this._eventDispatcher = new flash.events.EventDispatcher();
};
$hxClasses["gui.Control"] = gui.Control;
gui.Control.__name__ = ["gui","Control"];
gui.Control.__interfaces__ = [flash.events.IEventDispatcher];
gui.Control.__super__ = com.haxepunk.Entity;
gui.Control.prototype = $extend(com.haxepunk.Entity.prototype,{
	get_id: function() {
		return this.id;
	}
	...
	,added: function() {
		com.haxepunk.Entity.prototype.added.call(this);
		if(com.haxepunk.HXP.stage != null) {
			com.haxepunk.HXP.stage.addEventListener(flash.events.MouseEvent.MOUSE_DOWN,$bind(this,this.onMouseDown));
			com.haxepunk.HXP.stage.addEventListener(flash.events.MouseEvent.MOUSE_UP,$bind(this,this.onMouseUp));
			com.haxepunk.HXP.stage.addEventListener(flash.events.MouseEvent.CLICK,$bind(this,this.onMouseClick));
		}
	}
	,update: function() {
		com.haxepunk.Entity.prototype.update.call(this);
		if(this.collidePoint(this.followCamera?this.x + com.haxepunk.HXP.camera.x:this.x,this.followCamera?this.y + com.haxepunk.HXP.camera.y:this.y,com.haxepunk.utils.Input.get_mouseX() + com.haxepunk.HXP.camera.x,com.haxepunk.utils.Input.get_mouseY() + com.haxepunk.HXP.camera.y)) this.dispatchEvent(new gui.CEvent("mouse_over",this.id));
	}
	,removed: function() {
		com.haxepunk.Entity.prototype.removed.call(this);
		if(com.haxepunk.HXP.stage != null) {
			com.haxepunk.HXP.stage.removeEventListener(flash.events.MouseEvent.MOUSE_DOWN,$bind(this,this.onMouseDown));
			com.haxepunk.HXP.stage.removeEventListener(flash.events.MouseEvent.MOUSE_UP,$bind(this,this.onMouseUp));
			com.haxepunk.HXP.stage.removeEventListener(flash.events.MouseEvent.CLICK,$bind(this,this.onMouseClick));
		}
	}
	...
	,onMouseDown: function(e) {
		if(this.collidePoint(this.followCamera?this.x + com.haxepunk.HXP.camera.x:this.x,this.followCamera?this.y + com.haxepunk.HXP.camera.y:this.y,com.haxepunk.utils.Input.get_mouseX() + com.haxepunk.HXP.camera.x,com.haxepunk.utils.Input.get_mouseY() + com.haxepunk.HXP.camera.y)) this.dispatchEvent(new gui.CEvent("mouse_down",this.id));
	}
	,onMouseUp: function(e) {
		if(this.collidePoint(this.followCamera?this.x + com.haxepunk.HXP.camera.x:this.x,this.followCamera?this.y + com.haxepunk.HXP.camera.y:this.y,com.haxepunk.utils.Input.get_mouseX() + com.haxepunk.HXP.camera.x,com.haxepunk.utils.Input.get_mouseY() + com.haxepunk.HXP.camera.y)) this.dispatchEvent(new gui.CEvent("mouse_up",this.id));
	}
	,onMouseClick: function(e) {
		if(this.collidePoint(this.followCamera?this.x + com.haxepunk.HXP.camera.x:this.x,this.followCamera?this.y + com.haxepunk.HXP.camera.y:this.y,com.haxepunk.utils.Input.get_mouseX() + com.haxepunk.HXP.camera.x,com.haxepunk.utils.Input.get_mouseY() + com.haxepunk.HXP.camera.y)) this.dispatchEvent(new gui.CEvent("mouse_click",this.id));
	}
	...
	,__class__: gui.Control
	,__properties__: $extend(com.haxepunk.Entity.prototype.__properties__,{set_alignment:"set_alignment",get_alignment:"get_alignment",set_id:"set_id",get_id:"get_id"})
});
gui.Button = function(label,x,y,alignment,newSize,width,height) {
	if(height == null) height = 0;
	if(width == null) width = 0;
	if(newSize == null) newSize = 16;
	if(alignment == null) alignment = "top_left";
	if(y == null) y = 0;
	if(x == null) x = 0;
	if(label == null) label = "Button";
	gui.Control.call(this,x,y,null,width,height);
	this.id = label;
	this.setRoot(alignment);
	this.alignment = alignment;
	this._textOptions = { size : newSize};
	this.set_graphic(new com.haxepunk.graphics.Text(label,0,0,0,0,this._textOptions));
	this.setHitboxTo(this._graphic);
	this.setRoot(alignment);
};
$hxClasses["gui.Button"] = gui.Button;
gui.Button.__name__ = ["gui","Button"];
gui.Button.__super__ = gui.Control;
gui.Button.prototype = $extend(gui.Control.prototype,{
	get_label: function() {
		return this.label;
	}
	,set_label: function(value) {
		this._graphic.destroy();
		this.set_graphic(new com.haxepunk.graphics.Text(value,0,0,0,0,this._textOptions));
		this.setHitboxTo(this._graphic);
		this.setRoot(this.alignment);
		return this.label = value;
	}
	,added: function() {
		gui.Control.prototype.added.call(this);
	}
	,update: function() {
		gui.Control.prototype.update.call(this);
	}
	,removed: function() {
		gui.Control.prototype.removed.call(this);
	}
	,__class__: gui.Button
	,__properties__: $extend(gui.Control.prototype.__properties__,{set_label:"set_label",get_label:"get_label"})
});
gui.CEvent = function(type,senderID,bubbles,cancelable) {
	if(cancelable == null) cancelable = false;
	if(bubbles == null) bubbles = false;
	this.senderID = senderID;
	flash.events.Event.call(this,type,bubbles,cancelable);
};
$hxClasses["gui.CEvent"] = gui.CEvent;
gui.CEvent.__name__ = ["gui","CEvent"];
gui.CEvent.__super__ = flash.events.Event;
gui.CEvent.prototype = $extend(flash.events.Event.prototype,{
	__class__: gui.CEvent
});
gui._Control = {};
gui._Control.Alignment_Impl_ = function() { };
$hxClasses["gui._Control.Alignment_Impl_"] = gui._Control.Alignment_Impl_;
gui._Control.Alignment_Impl_.__name__ = ["gui","_Control","Alignment_Impl_"];
gui.Label = function(text,x,y,alignment,textAlign,newSize,width,height) {
	if(height == null) height = 0;
	if(width == null) width = 0;
	if(newSize == null) newSize = 16;
	if(textAlign == null) textAlign = "left";
	if(alignment == null) alignment = "center_left";
	gui.Control.call(this,x,y,alignment,width,height);
	this.setRoot(alignment);
	this.alignment = alignment;
	var tta;
	var ta = textAlign;
	if(ta == "left") tta = flash.text.TextFormatAlign.LEFT; else {
		var ta1 = textAlign;
		if(ta1 == "right") tta = flash.text.TextFormatAlign.RIGHT; else {
			var ta2 = textAlign;
			if(ta2 == "center") tta = flash.text.TextFormatAlign.CENTER; else {
				var ta3 = textAlign;
				if(ta3 == "justify") tta = flash.text.TextFormatAlign.JUSTIFY; else tta = flash.text.TextFormatAlign.LEFT;
			}
		}
	}
	this._textOptions = { align : tta, size : newSize};
	this.set_graphic(new com.haxepunk.graphics.Text(text,0,0,0,0,this._textOptions));
	this.setHitboxTo(this._graphic);
	this.setRoot(alignment);
};
$hxClasses["gui.Label"] = gui.Label;
gui.Label.__name__ = ["gui","Label"];
gui.Label.__super__ = gui.Control;
gui.Label.prototype = $extend(gui.Control.prototype,{
	get_text: function() {
		return this.text;
	}
	,set_text: function(value) {
	...
	,__class__: gui.Label
	,__properties__: $extend(gui.Control.prototype.__properties__,{set_text:"set_text",get_text:"get_text"})
});
...
scenes.Game = function() {
	...
	this._lGameOver = new gui.Label("GAME OVER",com.haxepunk.HXP.halfWidth,com.haxepunk.HXP.halfHeight - 32,"bottom",null,64);
	this._lHighScores = new gui.Label("SCORE : ? (BEST: ? / ALL-TIME: ?)",com.haxepunk.HXP.halfWidth,com.haxepunk.HXP.halfHeight - 24,"bottom");
	this._lInstructions = new gui.Label("AVOID COLLISION\nLEFT CLICK / SPACE / W / UP\nTO JUMP\n\nJUMP TO PLAY",com.haxepunk.HXP.halfWidth,com.haxepunk.HXP.halfHeight,"center","center",24);
	this._bMenu = new gui.Button("MENU",com.haxepunk.HXP.halfWidth,com.haxepunk.HXP.halfHeight + 88,"top",32);
	this._bRestart = new gui.Button("RESTART",com.haxepunk.HXP.halfWidth,com.haxepunk.HXP.halfHeight + 24,"top",32);
	this._lScore = new gui.Label("SCORE: ",com.haxepunk.HXP.halfWidth,48,"center");
};
$hxClasses["scenes.Game"] = scenes.Game;
scenes.Game.__name__ = ["scenes","Game"];
scenes.Game.__super__ = com.haxepunk.Scene;
scenes.Game.prototype = $extend(com.haxepunk.Scene.prototype,{
	begin: function() {
		com.haxepunk.Scene.prototype.begin.call(this);
		this.add(this._player);
		this.add(this._lGameOver);
		this.add(this._lHighScores);
		this.add(this._lInstructions);
		this.add(this._lScore);
		this.add(this._bMenu);
		this.add(this._bRestart);
		this.init();
	}
	,init: function() {
		this._player.init();
		this._score = 0;
		this._lScore.visible = false;
		this._lGameOver.visible = false;
		this._lHighScores.visible = false;
		this._lInstructions.visible = true;
		this._bMenu.visible = false;
		this._bRestart.visible = false;
		this._bMenu.removeEventListener("mouse_click",$bind(this,this.sceneHandler));
		this._bRestart.removeEventListener("mouse_click",$bind(this,this.sceneHandler));
	}
	,update: function() {
		com.haxepunk.Scene.prototype.update.call(this);
		if(this._player.isReady && this._player.isAlive) {
			this._lInstructions.visible = false;
			this._lScore.visible = true;
			this.play();
	...
	,play: function() {
		...
		if(this._spawnTimer >= 0.3) {
			this.create(entities.Obstacle,true).init();
			this._spawnTimer = 0;
		}
		this._score += com.haxepunk.HXP.elapsed;
		this._lScore.set_text("SCORE: " + (this._score | 0));
	}
	,showScoreboard: function() {
		this.recordScore();
		this._lHighScores.set_text("SCORE: " + (this._score | 0) + " (BEST: " + Std.string(Main.so.data.sessionbest) + " / ALL-TIME: " + Std.string(Main.so.data.score) + ") ");
		this._lGameOver.visible = true;
		this._lHighScores.visible = true;
		this._bMenu.visible = true;
		this._bRestart.visible = true;
		if(!(this._bMenu.hasEventListener("mouse_click") && this._bRestart.hasEventListener("mouse_click"))) {
			if(!entities.Obstacle.isOnCamera) this._bRestart.addEventListener("mouse_click",$bind(this,this.sceneHandler));
			this._bMenu.addEventListener("mouse_click",$bind(this,this.sceneHandler));
		}
		if(!entities.Obstacle.isOnCamera) {
			if(com.haxepunk.utils.Input.pressed("start")) this.init();
		}
		if(com.haxepunk.utils.Input.pressed("exit")) com.haxepunk.HXP.set_scene(Main.sceneMenu);
	}
	,recordScore: function() {
		try {
			Main.so = flash.net.SharedObject.getLocal("highscore");
		} catch( error ) {
			haxe.Log.trace("SharedObject error: " + Std.string(error),{ fileName : "Game.hx", lineNumber : 159, className : "scenes.Game", methodName : "recordScore"});
		}
		if((this._score | 0) > Std["int"](Main.so.data.sessionbest)) {
			Main.so.data.sessionbest = this._score | 0;
			Main.so.flush();
		}
		if((this._score | 0) > Std["int"](Main.so.data.score)) {
			Main.so.data.score = this._score | 0;
			Main.so.flush();
		}
	}
	,sceneHandler: function(e) {
		var _g = e.senderID;
		var id = _g;
		if(id == this._bMenu.id) com.haxepunk.HXP.set_scene(Main.sceneMenu); else {
			var id1 = _g;
			if(id1 == this._bRestart.id) this.init();
		}
	}
	,end: function() {
		com.haxepunk.Scene.prototype.end.call(this);
		this.removeAll();
		this._bMenu.removeEventListener("mouse_click",$bind(this,this.sceneHandler));
		this._bRestart.removeEventListener("mouse_click",$bind(this,this.sceneHandler));
	}
	,__class__: scenes.Game
});
scenes.MainMenu = function() {
	this._spawnTimer = 0;
	com.haxepunk.Scene.call(this);
	this.lTitle = new gui.Label("TOCHKA",com.haxepunk.HXP.halfWidth,com.haxepunk.HXP.halfHeight - 32,"bottom",null,64);
	this.lMadeBy = new gui.Label("BY DOMAGOJ STREKELJ",com.haxepunk.HXP.halfWidth,com.haxepunk.HXP.halfHeight - 24,"bottom",null,16);
	this.bStart = new gui.Button("START",com.haxepunk.HXP.halfWidth,com.haxepunk.HXP.halfHeight + 24,"top",32);
	this.bQuit = new gui.Button("QUIT",com.haxepunk.HXP.halfWidth,com.haxepunk.HXP.halfHeight + 88,"top",32);
	com.haxepunk.utils.Input.define("start",[13]);
	com.haxepunk.utils.Input.define("exit",[27,8]);
};
$hxClasses["scenes.MainMenu"] = scenes.MainMenu;
scenes.MainMenu.__name__ = ["scenes","MainMenu"];
scenes.MainMenu.__super__ = com.haxepunk.Scene;
scenes.MainMenu.prototype = $extend(com.haxepunk.Scene.prototype,{
	begin: function() {
		com.haxepunk.Scene.prototype.begin.call(this);
		this.add(this.lTitle);
		this.add(this.lMadeBy);
		this.add(this.bStart);
		this.bStart.addEventListener("mouse_click",$bind(this,this.sceneHandler));
	}
	,update: function() {
		com.haxepunk.Scene.prototype.update.call(this);
		if(com.haxepunk.utils.Input.pressed("start")) com.haxepunk.HXP.set_scene(Main.sceneGame);
		this._spawnTimer += com.haxepunk.HXP.elapsed;
		if(this._spawnTimer >= 0.3) {
			this.create(entities.Obstacle,true).init();
			this._spawnTimer = 0;
	...
	,end: function() {
		com.haxepunk.Scene.prototype.end.call(this);
		this.removeAll();
		this.bStart.removeEventListener("mouse_click",$bind(this,this.sceneHandler));
	}
	,sceneHandler: function(e) {
		var _g = e.senderID;
		var id = _g;
		if(id == this.bStart.id) com.haxepunk.HXP.set_scene(Main.sceneGame);
	}
	,__class__: scenes.MainMenu
});
...
com.haxepunk.HXP.VERSION = "2.5.2";
...
com.haxepunk.utils.HaxelibInfo.version = "2.5.2";
com.haxepunk.utils.HaxelibInfo.url = "http://haxepunk.com";
com.haxepunk.utils.HaxelibInfo.install = { openfl : "1.2.3", 'openfl-native' : "1.2.4", 'lime-tools' : "1.3.0", 'openfl-bitfive' : "1.0.5", 'openfl-html5-dom' : "1.2.1", lime : "0.9.5", 'openfl-ouya' : "1.0.2"};
...
com.haxepunk.utils.OUYA_GAMEPAD.LEFT_ANALOGUE_BUTTON = 10;
com.haxepunk.utils.OUYA_GAMEPAD.RIGHT_ANALOGUE_BUTTON = 11;
com.haxepunk.utils.OUYA_GAMEPAD.LEFT_TRIGGER_BUTTON = 8;
com.haxepunk.utils.OUYA_GAMEPAD.RIGHT_TRIGGER_BUTTON = 9;
...
entities.Obstacle.velocity = 7.0;
...
gui.Control.MOUSE_OVER = "mouse_over";
gui.Control.MOUSE_DOWN = "mouse_down";
gui.Control.MOUSE_UP = "mouse_up";
gui.Control.MOUSE_CLICK = "mouse_click";
gui._Control.Alignment_Impl_.TOP_LEFT = "top_left";
gui._Control.Alignment_Impl_.TOP = "top";
gui._Control.Alignment_Impl_.TOP_RIGHT = "top_right";
gui._Control.Alignment_Impl_.CENTER_LEFT = "center_left";
gui._Control.Alignment_Impl_.CENTER = "center";
gui._Control.Alignment_Impl_.CENTER_RIGHT = "center_right";
gui._Control.Alignment_Impl_.BOTTOM_LEFT = "bottom_left";
gui._Control.Alignment_Impl_.BOTTOM = "bottom";
gui._Control.Alignment_Impl_.BOTTOM_RIGHT = "bottom_right";
...
scenes.Game._SPAWN_RATE = 0.3;
scenes.MainMenu._SPAWN_RATE = 0.3;
